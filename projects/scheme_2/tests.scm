...
(quote (def pi 3.14159))
; expect (def pi 3.14159)

''''(quote (def f (* 10 4)))
; expect (quote (quote (quote (quote (def f (* 10 4))))))

(begin (begin (+ 7 9) (define x (+ 5 5)) (+ x 2)) (/ 1 0))
; expect Error
...
(lambda a (lambda a (def a 2)))
; expect (lambda a (lambda a (def a 2)))
...
(define (proc param_a param_b) param_a param_b (+ param_a param_b))
; expect proc
...
(let((x 79) (y (+ 0 x))) (+ x (+ 313 y)))
; expect -199607


(define f (mu () (* factor1 factor2)))
; expect f

(define proc (lambda () (define factor1 7) (define factor2 4) (f)))
; expect proc

proc
; expect (lambda () (define factor1 7) (define factor2 4) (f))
